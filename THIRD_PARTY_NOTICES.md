...
| MAX core | `26.5.0` | `LicenseRef-Modular-Proprietary`, as declared by the pinned Modular package; supplied separately with its upstream distribution terms |
...
MAX core (required when consuming the precompiled package), the compiler, and
the Mojo runtime are supplied separately by the pinned Pixi packages and retain their upstream distribution terms and notices. This source
